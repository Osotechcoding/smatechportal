...
<!-- Mirrored from einfosoft.com/flexweb_template/edusquad_theme/edusquad-preview/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 Aug 2022 04:25:54 GMT -->
<head>
    <!-- ========== Meta Tags ========== -->
    <meta charset="utf-8">
    <meta content="width=device-width, initial-scale=1" name="viewport">
    <meta content="Edusquad - Education Template" name="description">
    <!-- ========== Page Title ========== -->
                ...
                <div class="collapse navbar-collapse justify-content-end" id="collapsibleNavbar">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:" data-toggle="dropdown">About</a>
...
<!-- Mirrored from einfosoft.com/flexweb_template/edusquad_theme/edusquad-preview/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 Aug 2022 04:25:55 GMT -->
</html>
