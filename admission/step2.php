...
<!-- Mirrored from entiretimes.com/html/school/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 04 Jul 2022 20:32:34 GMT -->
<head>
<!-- Required meta tags -->
<meta charset="utf-8">
            ...
            <div class="row">
              ...
              <div class="row">
                <div class="col-md-12 col-lg-12">
                  <div class="form-group">
                    <input type="text" name="name" class="form-control" placeholder="student@smatech.edu.ng">
                    <div class="passnote">Note: Email must be an active e-mail</div>
                  </div>
                </div>
                <div class="col-md-12 col-lg-12">
                  <div class="form-group">
                    <input type="email" name="name" class="form-control" placeholder="Username">
                      <div class="passnote">Note: Use your Surname is your Username</div>
                  </div>
                </div>
                <div class="col-md-12 col-lg-12">
                  <div class="form-group">
                ...
                <div class="col-md-12 col-lg-12">
                  ...
                  <select class="custom-select form-control" name="">
                    ...
                    <option value="">Primary Level Level</option>
