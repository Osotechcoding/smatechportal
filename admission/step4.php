            ...
            <div class="row g-0">
              <div class="col-xl-12 col-md-12 mb-3">
                <div class="card-body p-md-5 text-black">
                  <h3 class="mb-5 text-uppercase text-center text-black">Admission Form (Previous School Information)</h3>
               ...
               <input type="text" class="form-control" value="<?php echo ucwords($student_data->studentClass);?>" readonly>
                    ...
                    <div class="col-md-6 mb-3">
                         <div class="form-group">
                            ...
                            <input type="text" autocomplete="off" class="form-control" name="prev_schoolname" placeholder="Name of your Previous school">
                         </div>
                     </div>
                     <div class="col-md-6 mb-3">
                         <div class="form-group">
                        <label>Name of Director/Proprietress</label>
                        <input type="text" autocomplete="off" class="form-control" name="proprietress" placeholder="e.g Mr. Ayomide Hamad">
                         </div>
                     </div>
                     <div class="col-md-6 mb-3">
                         <div class="form-group">
                            <label>Previous School Phone </label>
                            <input type="text" autocomplete="off" class="form-control" name="prev_schl_phone" placeholder="Previous School Phone">
                         </div>
                     </div>
                     <div class="col-md-6 mb-3">
                         <div class="form-group">
                     ...
                     <div class="col-md-6 mb-3">
                       ...
                       <input type="text" autocomplete="off" class="form-control" name="present_class" placeholder="Enter Your Present Class here">
                         </div>
                     </div>
                     <div class="col-md-6 mb-3">
                         <div class="form-group">
                   ...
                   <div style="float: left; margin-top:10px;"><a href="step3?applicant=<?php echo $Osotech->saltifyString($_GET['applicant'])?>&page=3" class="btn-shop green-color" onclick="return confirm('Are you Sure you want to go Back to Previous page?');"><button type="button" name="button" class="btn btn-secondary btn-md mt-2"> Previous Page</button></a></div>
                  <button type="submit" class="btn btn-dark btn-lg btn-round mb-5 __loadingBtn__ mt-5" style="float:right">Continue Registration</button>
                  </form>
                  </div>
                </div>
              </div>
