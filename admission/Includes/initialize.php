...
if (!defined("__OSOTECH__DEV_COMPANY__")) {
	...
	define("__SCHOOL_NAME__","School Management Application || Admission Portal");
	define("__SCHOOL_LOCATION_ADDRESS__","No 8,Road 20, Smatech Estate, Ikeja, Lagos, Nigeria");
	define("APP_ROOT","http://localhost/smatechportal/admission/");
	//define("APP_ROOT","https://admission.smatechportal.com/");
