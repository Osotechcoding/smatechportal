                ...
                <div class="row g-0">
                  <div class="col-xl-12 col-md-12 mb-3">
                    <div class="card-body p-md-5 text-black">
                      <h3 class="mb-5 text-uppercase text-center text-black">Admission Form (STUDENT MEDICAL HISTORY)
                      </h3>
                      ...
                      <form id="fifthStepForm">
                        ...
                        <div style="float: left; margin-top:10px;"><a
                            href="step4?applicant=<?php echo $Osotech->saltifyString($_GET['applicant']) ?>&page=4"
                            ...
                            onclick="return confirm('Are you Sure you want to go Back to Previous page?');"><button
                              ...
                              Page</button></a></div>
                        <button type="submit" class="btn btn-dark btn-lg btn-round mb-1 __loadingBtn__ mt-2"
