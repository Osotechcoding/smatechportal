                ...
                <div class="row g-0">
                  <div class="col-xl-12 col-md-12 mb-3">
                    <div class="card-body p-md-5 text-black">
                      <h3 class="mb-5 text-uppercase text-center text-black">Admission Form (Student Document Uploading)
                      </h3>
                      ...
                      <form id="finalStepForm" method="POST" enctype="multipart/form-data">
                        <div class="row">
                          ...
                          <div class="col-md-12 mb-3">
                            <div class="form-group">
                              <i class="text-danger">Please Note that your Passport size must not be up to 20KB and
                                dimension should be (100 x 100 pixels)</i>
                              <label for="student_passport">Choose Passport</label>
                              <input type="file" class="form-control custom-file" name="student_passport"
                                id="student_passport" onchange="previewFile(this);">
                            </div>
                          </div>
                          <center>
                            <div class="col-md-12" id="uploaded_passport">
                              <img id="previewImg" width="200" src="avatar.jpg" alt="Placeholder"
                                style="border: 5px solid darkblue;border-radius:10px;">
                              <p class="text-center text-muted">Image Size: <span id="ImageSize"></span></p>
                            </div>
                          </center>
                          <p class="mt-3 text-danger"><input type="checkbox" class="checkbox__input"> <b>By submitting
                              your application form you agree to the Terms and Condition of </b> <strong
                              class="text-info"><?php echo ($Osotech->getConfigData()->school_name); ?>
                              <?php echo ($Osotech->getConfigData()->school_state); ?> </strong></p>
                        </div>
                        <div style="float: left; margin-top:10px;"><a
                            href="step5?applicant=<?php echo $_GET['applicant'] ?>&page=5" class="btn-shop green-color"
                        ...
                        <button type="submit" class="btn btn-dark btn-lg btn-round mb-1 __loadingBtn__ mt-5"
                          style="float:right"
                          onclick="return confirm('Are you Sure you want to submit this form?');">Submit
                          Registration</button>
    ...
    ADMISSION_FORM_SUBMIT.on("submit", function(event) {
      ...
      if ($('.checkbox__input').is(":checked") == true) {
        $.ajax({
          ...
          processData: false,
          beforeSend() {
            $(".__loadingBtn__").html('<img src="rolling_loader.svg" width="30"> Processing...').attr(
              "disabled", true);
          },
