                ...
                <div class="row g-0">
                  <div class="col-xl-12 col-md-12 mb-3">
                    <div class="card-body p-md-5 text-black">
                      <h3 class="mb-5 text-uppercase text-center text-black">Admission Form (Parents/Guardian
                        Information)</h3>
                      <form id="thirdStepForm">
                        ...
                        <div class="row">
                          ...
                          <div class="row">
                            <div class="col-md-6 mb-3">
                              <div class="form-group">
                                <label>Title </label>
                                <input type="text" autocomplete="off" name="mg_title" class="form-control"
                            ...
                            <div class="col-md-6 mb-3">
                              <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" name="mg_name" class="form-control"
                            ...
                            <div class="col-md-6 mb-3">
                              <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" name="mg_relation" class="form-control"
                                  placeholder=" Father">
                              </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                              <div class="form-group">
                                ...
                                <label> Phone </label>
                                <input type="text" autocomplete="off" name="mg_phone" class="form-control"
                            ...
                            <div class="col-md-6 mb-3">
                              <div class="form-group">
                                ...
                                <label> Email </label>
                                <input type="text" autocomplete="off" name="mg_email" class="form-control"
                            ...
                            <div class="col-md-6 mb-3">
                              <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" name="mg_occu" class="form-control"
                                  placeholder="Doctor" />
                              </div>
                            </div>
                            <div class="col-md-12 mb-3">
                              <div class="form-group">
                                <label> Address </label>
                                <textarea type="text" autocomplete="off" name="mg_address" class="form-control"
                          ...
                          <div class="row">
                            <div class="col-md-6 mb-3">
                              <div class="form-group">
                                <label>Title </label>
                                <input type="text" autocomplete="off" name="fg_title" class="form-control"
                                  placeholder="High Chief">
                              </div>
                            </div>
                            <div class="col-md-6 mb-3">
                              <div class="form-group">
                                <label>Full Name</label>
                                <input type="text" autocomplete="off" name="fg_name" class="form-control"
                            ...
                            <div class="col-md-6 mb-3">
                              <div class="form-group">
                                <label> Relationship </label>
                                <input type="text" autocomplete="off" name="fg_relation" class="form-control"
                                  placeholder="Mother">
                              </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                              <div class="form-group">
                                ...
                                <label> Phone </label>
                                <input type="text" autocomplete="off" name="fg_phone" class="form-control"
                                  placeholder="082135432123">
                              </div>
                            </div>
                            <div class="col-md-6 mb-3">
                              <div class="form-group">
                                ...
                                <label> Email </label>
                                <input type="text" autocomplete="off" name="fg_email" class="form-control"
                            ...
                            <div class="col-md-6 mb-3">
                              <div class="form-group">
                                <label> Occupation </label>
                                <input type="text" autocomplete="off" name="fg_occu" class="form-control"
                                  placeholder="Doctor" />
                              </div>
                            </div>
                            <div class="col-md-12 mb-3">
                              <div class="form-group">
                                <label> Address </label>
                                <textarea type="text" autocomplete="off" name="fg_address" class="form-control"
                                  placeholder=" Sango Ota Ogun State"></textarea>
                              </div>
                            </div>
                          </div>
                        ...
                        <div style="float: left; margin-top:10px;"><a
                            href="step2?applicant=<?php echo $Osotech->saltifyString($_GET['applicant']) ?>&page=2"
                            ...
                            onclick="return confirm('Are you Sure you want to go Back to Previous page?');"><button
                              ...
                              Page</button></a></div>
                        <button type="submit" class="btn btn-dark btn-lg btn-round mb-1 __loadingBtn__ mt-5"
