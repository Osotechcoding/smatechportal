        ...
        <div class="post mb-xl-0 mb-lg-0 mb-md-0 mb-5" data-aos="fade-up" data-aos-duration="550">
          ...
          <div class="post_inner p-3">
            ...
            <h5 class="font-weight-bold"><a
                href="blog-detail?bId=<?php echo $value->blog_id; ?>&action=view"><?php echo $value->blog_title; ?></a>
            </h5>
            <p class="lead"><?php
            ...
            <div class="comment d-flex">
              ...
              <span class="mr-3"><i
                  class="fa fa-comments mr-3 color-orange"></i><?php echo $value->category_id; ?></span>
            </div>
            <a href="blog-detail?bId=<?php echo $value->blog_id; ?>&action=view"
              class="btn color-orange read-more mt-3">Read More</a>
          </div>
        </div>
      </div>
      <?php
