...
<head>
  ...
  <title>Developer Login :: <?php echo ucwords($SmappDetails->school_name); ?> </title>
  <link rel="stylesheet"
        ...
        <div class="loginbox">
          <div class="login-left">
            ...
            <h3 class="text-center text-warning mt-3"><?php echo ucwords($SmappDetails->school_short_name); ?> <h3>
                <p class="text-center" style="font-size: 14px;"> <span class="text-white">Powered by:
                    <?php echo __OSOTECH__DEV_COMPANY__ ?></span></p>
          </div>
  ...
  $(document).ready(function() {
    $("#adminLoginForm").on("submit", function(event) {
      ...
      $.ajax({
        ...
        beforeSend: function() {
          $(".__loadingBtn__").html(
            '<img src="assets/loaders/rolling_loader.svg" width="30"> Processing...').attr("disabled",
            true);
        },
