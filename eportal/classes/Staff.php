...
class Staff
{
	...
	public function create_new_staff($d)
	{
		...
		if (
			$this->config->isEmptyStr($surName) || $this->config->isEmptyStr($firstName) ||
    ...
    reset your password!",  "success");
						...
						$this->response = $this->alert->alert_toastr("Oops!, Something went wrong, Reset link sent failed, Please
    try again!", "danger");
					}
				}
			}
