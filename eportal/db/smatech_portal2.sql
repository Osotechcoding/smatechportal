...
(1, 'Smatech', 'admin@smatech.com', 'IA6YFiGX5Nuz6yQKNXvxDeWQjpJkNK7emSWlCPKRHgcXj2aNtYJwB1d7SpBTN5rMA4DB7ZdCWl3CTCIfJGDwgcaULsDvR2Eyv2YQF'),
...
--
-- Dumping data for table `visap_parents_tbl`
--

INSERT INTO `visap_parents_tbl` (`id`, `fname`, `lname`, `phone`, `email`, `address`, `occupation`, `gender`, `pta_post`, `created_at`) VALUES
(1, 'Yakubu', 'Idowu', '07033315307', 'yakubuid@smatech.com', 'Sample address only', 'Teacher', 'Female', 'PTA Member', '2023-02-01 03:30:19');
...
(1, 'JSS 1A', 'Agricultural Science', 'Smatech', '2023-01-29'),
(2, 'JSS 1A', 'Basic Science', 'Smatech', '2023-01-29'),
(3, 'JSS 1A', 'BST', 'Smatech', '2023-01-29'),
(4, 'JSS 1A', 'Business Studies', 'Smatech', '2023-01-29'),
(5, 'JSS 1A', 'CCA', 'Smatech', '2023-01-29'),
(6, 'JSS 1A', 'Civic Education', 'Smatech', '2023-01-29'),
(7, 'JSS 1A', 'Current Affairs', 'Smatech', '2023-01-29'),
(8, 'JSS 1A', 'English Language', 'Smatech', '2023-01-29'),
(9, 'JSS 1A', 'Mathematics', 'Smatech', '2023-01-29'),
(10, 'JSS 1A', 'Yoruba Language', 'Smatech', '2023-01-29');
...
(1, 'SMP23001', NULL, 'Principal', 'Samson Idowu', 'Agberayi', 'idowu@gmail.com', '$2y$10$PNHEkp67NQgc4BVT73/tgOnGwNpYFvHx2czW0w2j43zVARPLE2d1y', 'Samson', '2000-10-05', 'BSC', '07031333715', NULL, '45, Olaotan Avenue, Off Ijoko Rd, Sango Ota, Ogun State', 'e462a4d668857a6', NULL, NULL, 'SMP230014943903.jpg', 'Male', NULL, 'idowu@SMAPP.portal', 1, 0, 'Teaching', '2022-01-13', NULL);
...
(1, '2021C263130001', 'osotech23@gmail.com', 'Oloruntoba', '$2y$10$xbJcQIntcNk3/iutAVml6ODLOUAyRsBCZzROjHxOCoiMwZO31q.de', 'JSS 1A', 'Oloruntoba', 'Elizabeth', 'Idowu', '1992-05-25', 'Female', 'Sango Ota, Ogun State, Nigeria', '08131374443', 'Active', '2000-03-07', 'Day', NULL, 'cd5b1373a22c37', NULL, NULL, 0, 'JSS 1A', NULL),
(2, '2021C263130002', 'adeyandipper@gmail.com', 'Adeyan', '$2y$10$DU0ZyI2JAq1zB03ll9RUAuFABHo3siO5WmaKdyytBaV4mBgndR3RG', 'JSS 3A', 'Adeyan', 'Adetayo', 'Dipper', '2000-09-24', 'Male', 'Sango Ota, Ogun State, Nigeria', '08132323456', 'Active', '2001-08-08', 'Boarding', '2021C2631300028534489.jpg', '58e4a3501517f9', NULL, NULL, 0, 'JSS 1A', '2023-01-30');
...
(1, '2021C263130002', 'JSS 1A', '2001-08-08', 'JSS 3A', '2023-01-30', 'Very Good', 'Good', 'None', 'Jets Club', 'He is a Good Student', 'Well Behaved', 'Mathematics', 'English Language', 'Agricultural Science', 'Yoruba Language', 'CCA', 'Home Economics', 'Computer', 'Music', 'Business Studies', NULL, NULL, '9266044170', '2023-01-30 07:01:45');
