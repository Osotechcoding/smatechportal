                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <?php if ($_SESSION['STAFF_GENDER'] == 'Male') {
                              $title = "Mr. " . $_SESSION['STAFF_FULL_NAME'];
                            } else {
                              $title = "Mrs. " . $_SESSION['STAFF_FULL_NAME'];
                            } ?>
                      <input type="text" name="class_teacher" class="form-control" value="<?php echo $title; ?>"
                        readonly>
                    </div>
                  </div>
                  <!-- <div class="col-md-6">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h2 class="modal-title" id="exampleModalLongTitle" style="font-size: 30px;font-weight: 700;"><i
              class="fa fa-file fa-2x"></i> Upload Affective Domain In CSV</h2>
