          ...
          <div class="card text-center bg-dark">
            <div class="card-body py-1">
              ...
              <h3 class="mb-0 text-white">
                <?php echo $Student->count_students_by_gender_class($staff_assigned_class, "Male"); ?></h3>
            </div>
          </div>
        </div>
        <div class="col-md-4 dashboard-users-white">
          <div class="card text-center bg-dark">
            <div class="card-body py-1">
              ...
              <h3 class="mb-0 text-white">
                <?php echo $Student->count_students_by_gender_class($staff_assigned_class, "Female"); ?></h3>
            </div>
          </div>
        </div>
        <div class="col-md-4 dashboard-users-white">
          <div class="card text-center bg-dark">
            <div class="card-body py-1">
              ...
              <h3 class="mb-0 text-white">
                <?php echo $Student->count_total_visap_students_class($staff_assigned_class); ?></h3>
            </div>
          </div>
        </div>
      </div>
