   ...
   <div class="main-menu-content">
     <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation"
       ...
       <li><a class="d-flex align-items-center" href="upload_lecture"><i class="bx bx-video-plus"></i><span
             class="menu-item text-truncate" data-i18n="Online Classroom">Online Classroom</span></a>
       </li>
       <li><a class="d-flex align-items-center" href="student_assignment"><i class="bx bx-edit-alt"></i><span
             class="menu-item text-truncate" data-i18n="Online Classroom">Online Assignment</span></a>
       </li>
       <li><a class="d-flex align-items-center" href="markstudentass"><i class="bx bx-edit-alt"></i><span
             class="menu-item text-truncate" data-i18n="Online Classroom">Mark Assignment</span></a>
       </li>
       <!-- RESULT -->
       <li class="nav-item"><a href="javaScript:void(0)"><i class="fa fa-bar-chart fa-1x" data-icon="notebook"></i><span
         ...
         <ul class="menu-content">
           ...
           <li class=" nav-item"><a href="view_uploaded_result"><i class="fa fa-eye fa-1x"></i><span
                 class="menu-title text-truncate" data-i18n="View Result">View Results</span></a>
           </li>
           <li class=" nav-item"><a href="editResult"><i class="fa fa-edit fa-1x"></i><span
                 class="menu-title text-truncate" data-i18n="Update Result">Update Result</span></a>
           </li>
           ...
           <li class="nav-item"><a href="view_uploaded_comment"><i class="fa fa-comment fa-1x"></i><span
                 class="menu-title text-truncate" data-i18n="Result Comments"> View Comments</span></a>
           </li>
           <li class=" nav-item"><a href="uploading_behavior"><i class="fa fa-eye fa-1x"></i><span
                 class="menu-title text-truncate" data-i18n="View Result">Upload Affective</span></a>
           </li>
           <li class=" nav-item"><a href="view_cognitive"><i class="fa fa-eye fa-1x"></i><span
                 class="menu-title text-truncate" data-i18n="View Result">View Affective</span></a>
           </li>
           <li class=" nav-item"><a href="psycho"><i class="fa fa-eye fa-1x"></i><span class="menu-title text-truncate"
                 data-i18n="Psychomotor"> Psychomotor</span></a>
           </li>
       ...
       <li class=" nav-item"><a href="javaScript:void(0)"><i class="fa fa-calendar fa-1x" data-icon="retweet"></i><span
         ...
         <ul class="menu-content">
           <li class=" nav-item"><a href="duty"><i class="fa fa-briefcase fa-1x"></i><span
                 class="menu-title text-truncate" data-i18n="Assign Duty">My Duties</span></a>
           </li>
           <li><a class="d-flex align-items-center" href="add_event"><i class="bx bx-right-arrow-alt"></i><span
                 class="menu-item text-truncate" data-i18n="Manage Event">School Events</span></a> </li>
           <li><a class="d-flex align-items-center" href="add_holidays"><i class="bx bx-right-arrow-alt"></i><span
                 class="menu-item text-truncate" data-i18n="Manage Holiday">Holidays</span></a> </li>
         </ul>
       </li>
       <li><a class="d-flex align-items-center" href="account-settings"><i class="fa fa-cogs"></i><span
