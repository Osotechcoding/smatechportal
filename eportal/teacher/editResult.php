  ...
  <div class="app-content content">
    ...
    <div class="content-wrapper">
      ...
      <div class="content-body">
        <div class="row">
          <div class="col-12">
            <h3 class="bd-lead text-primary text-bold"><span class="fa fa-line-chart fa-1x"></span> UPDATE STUDENT
              RESULT</h3>
          </div>
        </div>
        ...
        <div class="card">
              ...
              <div class="row border rounded py-2 mb-2">
                <div class="col-md-4">
                  ...
                  <fieldset class="form-group">
                    <input type="text" autocomplete="off" class="form-control" name="admission_no"
                      placeholder="**********">
                  </fieldset>
                </div>
                <div class="col-md-4">
                  ...
                  <fieldset class="form-group">
                    <select class="form-control" name="ClassGrade" id="ClassGrade">
                      <option value="<?php echo $staff_assigned_class; ?>" selected><?php echo $staff_assigned_class; ?>
                      </option>
                    </select>
                  </fieldset>
                </div>
                ...
                <div class="col-md-4 d-flex align-items-center">
                  <button type="submit" class="btn btn-primary btn-block glow users-list-clear mb-0"
                    name="submit_search_now">Show Score Sheet</button>
                </div>
              </div>
            </form>
          </div>
          ...
          <div class="card-body">
            ...
            <p class="text-center text-info"><strong>You are upading <b
                  class="text-center text-warning"><?php echo strtoupper($student_data->full_name); ?></b> EXAM SCORE
                on <?php echo strtoupper($subject) ?> for <?php echo strtoupper($term) ?> of
                <?php echo strtoupper($session) ?> Academic Session </strong></p>
              ...
              <div class="table-responsive">
                  ...
                  <tbody class="text-center">
                    <tr>
                      <td><?php if ($student_data->stdPassport == NULL || $student_data->stdPassport == "") : ?>
                        ...
                        <?php endif ?>
                        <?php else : ?>
                        <img src="../schoolImages/students/<?php echo $student_data->stdPassport; ?>" width="100"
                          alt="photo" style="border-radius: 10px;border: 3px solid darkblue;">
                        <?php endif ?>
                      </td>
                      <td><?php echo strtoupper($student_data->full_name); ?> </td>
                      <td> <?php echo strtoupper($search_result_data->subjectName); ?></td>
                      <td><input type="number" autocomplete="off" min="1" max="40"
                          value="<?php echo intval($search_result_data->ca); ?>" style="width: 100%;"
                          class="form-control form-control-lg" name="cass1"></td>
                      <td><input type="number" autocomplete="off" style="width: 100%;" min="1" max="60"
                          value="<?php echo intval($search_result_data->exam); ?>" class="form-control form-control-lg"
                          name="exam1">
                        <input type="hidden" name="std_admno"
                          value="<?php echo strtoupper($student_data->stdRegNo); ?>">
                        <input type="hidden" name="result_term"
                          value="<?php echo strtoupper($search_result_data->term); ?>">
                        <input type="hidden" name="result_session"
                          value="<?php echo strtoupper($search_result_data->aca_session); ?>">
                        <input type="hidden" name="result_class"
                          value="<?php echo strtoupper($search_result_data->studentGrade); ?>">
                        <input type="hidden" name="resultId"
                          value="<?php echo strtoupper($search_result_data->reportId); ?>">
                      </td>
                    </tr>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <!--  -->
                    <input type="password" autocomplete="off" class="form-control" name="Auth"
