                      ...
                      <div class="row">
                        ...
                        <div class="col-12 d-flex justify-content-end mt-1">
                          <button type="submit" name="show_broad_sheet_btn" class="btn btn-primary btn-md mr-1"><span
                              class="fa fa-address-card"></span> SHOW RESULT SHEET</button>
                        </div>
                      </div>
                    </div>
                  </form>
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h3 class="modal-title" id="exampleModalLongTitle" style="font-size: 30px;font-weight: 700;"><i
              class="fa fa-file fa-1x"></i> Upload Result using CSV FILE</h3>
          ...
          <div class="modal-body">
            <div class="col-md-12 col-12 col-xl-12 col-lg-12 col-sm-12">
              <div class="row">
                ...
                <input type="hidden" name="csv_schol_ses" value="<?php echo $activeSess->session_desc_name; ?>">
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="route_name">Choose CSV File </label>
                    <input type="file" name="" id="csv_file" accept=".csv"
