<div class="page-header">
  <div class="row">
    <div class="col-md-6">
      <h3 class="text-muted-light mb-0"><i class="fa fa-user"></i>Student:<b class="text-info">
          <?php echo ucwords($student_data->full_name); ?> </b></h3>
      <h3 class="text-muted-light mb-1"><i class="fa fa-pen"></i> <b>Class :
      ...
      <h3 class="text-muted-light mb-1"><i class="fa fa-graduation-cap"></i> <b>Joined Date
          :<?php echo date("Y-m-d", strtotime($student_data->stdApplyDate)); ?></b></h3>
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-12">
      ...
      <img src="../schoolImages/students/male.png" width="150" alt="passport"
        style="border:2px solid darkblue;border-radius: 10px;" class="float-right p-0 mb-0 mr-2">
      <?php else : ?>
      <img src="../schoolImages/students/female.png" width="150" alt="passport"
        style="border:2px solid darkblue;border-radius: 10px;" class="float-right p-0 mb-0 mr-2">
      <?php endif ?>

      <?php else : ?>
      <img src="../schoolImages/students/<?php echo $student_data->stdPassport; ?>" width="150" alt="passport"
        style="border:2px solid darkblue;border-radius: 10px;" class="float-right p-0 mb-0 mr-2">
      <?php endif ?>
