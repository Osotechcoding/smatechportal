...
<head>
    ...
    <title> <?php echo ucwords($Configuration->getConfigData()->school_name);?> :: <?php echo ucwords($student_data->full_name);?> Report Card for <?php echo $schl_session_data->active_session;?> </title>
<style>
html {
  font-family:arial;
  font-size: 9px;
