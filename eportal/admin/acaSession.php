...
<body class="vertical-layout vertical-menu-modern semi-dark-layout 2-columns  navbar-sticky footer-static  "
                ...
                <div class="card text-center bg-warning">
                  <div class="card-body py-1">
                    ...
                    <div class="text-white line-ellipsis">
                      <h3 class="text-white">Current</h3>
                    </div>
              ...
              <div class="col-md-3 dashboard-users-success">
                <div class="card text-center bg-danger">
                  <div class="card-body py-1">
                    ...
                    <div class="text-white line-ellipsis">
                      <h3 class="text-white">Vacation</h3>
                    </div>
        ...
        <section id="basic-horizontal-layouts">
          <div class="row match-height">
            ...
            <div class="col-md-6 col-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="text-center"> Academic Term & Session Management <button type="button"
                      class="btn btn-secondary block" data-toggle="modal" data-target="#active_session_form">
                      Declare New Session
                    </button> </h4>
                </div>
                <div class="card-body">
            ...
            <div class="col-md-6 col-12">
              <div class="card">
                <div class="card-header">
                  <h2 class="text-center">Session Information <button type="button" class="btn btn-danger block"
                      data-toggle="modal" data-target="#simulation_Modal_Form">
                      Simulate Session
                    </button></h2>
                </div>
                <div class="card-body">
                  <form class="form form-horizontal">
                    <div class="form-body">
                      <div class="row">
                        ...
                        <div class="col-md-8 form-group ">
                          <div class="position-relative has-icon-left">
                            <input type="text" class="form-control" value="<?php echo $session_data->active_session; ?>"
                              readonly>
                            <div class="form-control-position">
                              <i class="bx bx-calendar"></i>
                            </div>
                        ...
                        <div class="col-md-8 form-group">
                          <div class="position-relative has-icon-left">
                            <input type="text" class="form-control" value="<?php echo $session_data->active_term; ?>"
                              readonly>
                            <div class="form-control-position">
                              <i class="bx bx-cog"></i>
                            </div>
                        ...
                        <div class="col-md-8 form-group">
                          <div class="position-relative has-icon-left">
                            <input type="text" class="form-control"
                              value="<?php echo date("l jS F Y", strtotime($session_data->new_term_begins)); ?>"
                              readonly>
                            <div class="form-control-position">
                              <i class="bx bx-calendar"></i>
                            </div>
                        ...
                        <div class="col-md-8 form-group">
                          <div class="position-relative has-icon-left">
                            <input type="text" class="form-control" value="<?php echo $session_data->Days_open; ?> Days"
                              readonly>
                            <div class="form-control-position">
                              <i class="bx bx-calendar"></i>
                            </div>
    ...
    <div class="modal-dialog modal-dialog-scrollable">
      <div class="modal-content">
        <div class="text-center mt-1">
          <?php echo $Alert->alert_msg("Notice: Session Declared here will Override the Current academic Session!", "warning"); ?>
        </div>
        <form id="submit_New_Session_Form">
          <div class="modal-body">
            <div class="form-group">
              <label for="new_session_dec">Active Session</label>
              <input type="text" id="new_session_dec" class="form-control form-control-lg" name="new_session_dec"
                placeholder="eg 2021/2022" required>
            </div>
  ...
  <!--Basic Modal -->
  <div class="modal fade text-left" id="simulation_Modal_Form" tabindex="-1" role="dialog"
        ...
        <form id="simulation_Form">
          <div class="modal-body">
            <div class="form-group">
              ...
              <select name="simulate_to_session" id="navigate_to" class="custom-select form-control">
  ...
  <!-- BEGIN: Page JS-->
  <script src="smappjs/acasession.js"></script>
  <!-- END: Page JS-->
</body>
<!-- END: Body-->
