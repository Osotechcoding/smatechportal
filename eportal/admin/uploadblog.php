...
<body class="vertical-layout vertical-menu-modern semi-dark-layout 2-columns  navbar-sticky footer-static  "
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <button type="button" class="btn btn-dark btn-lg btn-round" data-toggle="modal"
                    data-target="#uploadNewsModal"><span class="fa fa-edit fa-1x"></span> Upload Blogs</button>
                </div>
                    ...
                    <table class="table table-striped table-bordered osotechDatatable">
                      ...
                      <tbody class="text-center">
                        ...
                        <tr>
                          ...
                          <td><span class="badge badge-dark badge-rounded badge-lg"><?php echo $count_comment; ?>
                            </span></td>
                          <!-- <td><span class="badge badge-pill badge-info badge-md"><?php //echo ($values->total_view > 0 ) ? $values->total_view : '0';
                                                                                          ?> </span></td> -->
                          <td>
                            <button class="btn btn-info btn-sm rounded m-1" type="button"
                              onclick="window.location.href=' blogedit?blogId=<?php echo $values->blog_id; ?>&action=edit';"><span
                                class="fa fa-edit mr-1"></span></button>
                            <button class="btn btn-dark btn-sm rounded m-1" type="button"
                              onclick="window.location.href='blogcomments?blogId=<?php echo $values->blog_id; ?>&action=view';"><span
                                class="fa fa-eye mr-1"></span></button>
                            <button
                              class="btn btn-danger btn-sm rounded delete_blog_btn m-1 __loadingBtn2__<?php echo $values->blog_id; ?>"
                              type="button" data-action="delete_blog_by_id"
                              data-id="<?php echo $values->blog_id; ?>">Remove</button>
  ...
  <!-- BEGIN: Footer-->
  <!-- BUS MODAL Start -->
  <div class="modal fade" id="uploadNewsModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
    aria-hidden="true">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h2 class="modal-title" id="exampleModalLongTitle" style="font-size: 30px;font-weight: 700;"><i
              class="fa fa-edit fa-1x"></i> Upload School News</h2>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" autocomplete="off" class="form-control form-control-lg" name="blogTitle"
                      placeholder="Common Errors in English Language">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                ...
                <div class="col-12 mt-1">
                  <fieldset class="form-label-group mb-0">
                    <textarea data-length=63000 class="form-control char-textarea" id="textarea-counter" rows="5"
                      placeholder="News content goes here... (Max Character (63000))" name="blogContent"></textarea>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="blogImage">News Image <span class="text-danger">(png,jpg or jpeg format
                        Only)</span></label>
                    <input type="file" class="form-control form-control-lg" id="blogImage" name="blogImage"
                      onchange="previewFile(this);">
                  </div>
                  <div class="col-md-6 offset-md-3" id="uploaded_passport">
                    <img id="previewImg" width="200" src="../assets/loaders/placeholder.png" alt="Placeholder"
  ...
  $(document).ready(function() {
    ...
    const delete_blog_btn = $(".delete_blog_btn");
    delete_blog_btn.on("click", function() {
      let tId = $(this).data("id");
      let action = $(this).data("action");
      let is_true = confirm("Are you Sure you want to Remove this Blog Post?");
      if (is_true) {
        $(".__loadingBtn2__" + tId).html(
          '<img src="../assets/loaders/rolling_loader.svg" width="20"> Processing...').attr("disabled", true);
        //send request
