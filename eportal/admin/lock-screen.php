...
<head>
    ...
    <title>Lock Screen :: <?php echo __SCHOOL_NAME__ ?> </title>
        ...
        <div class="card bg-authentication mb-0">
            <div class="row m-0">
                    ...
                    <div class="card disable-rounded-right mb-0 p-2">
                        ...
                        <div class="card-body">
                            <div class="text-center">
                                   ...
                                   <center> <img src="../schlogo.jpg" class="avatar" height="100" width="100" alt="avatar"></center>
                                </div>
                                </div>
                ...
                <div class="col-md-6 d-md-block d-none text-center align-self-center">
                    <img class="img-fluid" src="../schlogo.jpg" alt="school logo"
                        width="350">
                </div>
            </div>
        </div>
