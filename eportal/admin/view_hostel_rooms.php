...
<head>
  ...
  <title><?php echo $SmappDetails->school_name; ?> :: Viewing <?php echo ucwords($roomDetails->room_desc) ?> Bed Space
  </title>
...
<body class="vertical-layout vertical-menu-modern semi-dark-layout 2-columns  navbar-sticky footer-static  "
  ...
  <div class="app-content content">
    ...
    <div class="content-wrapper">
          ...
          <div class="breadcrumbs-top">
            ...
            <div class="breadcrumb-wrapper d-none d-sm-block">
              <ol class="breadcrumb p-0 mb-0 pl-1">
                ...
                <li class="breadcrumb-item active"><?php echo strtoupper($hostel_details->hostel_desc) ?> &raquo;
                  <?php echo strtoupper($roomDetails->room_desc) ?>
                </li>
              </ol>
            </div>
          </div>
      ...
      <div class="content-body">
        <div class="row">
          <div class="col-12">
            <h3 class="bd-lead text-primary text-bold"><span class="fa fa-hotel fa-1x"></span>
              <?php echo strtoupper($hostel_details->hostel_desc) ?> &raquo;
              (<?php echo strtoupper($hostel_details->hostel_type) ?> HOSTEL) &raquo;
                ...
                <div class="card text-center bg-dark">
                  <div class="card-body py-1">
                    ...
                    <div class="text-white line-ellipsis">
                      <h3 class="text-white"> Bed Space</h3>
                    </div>
              ...
              <div class="col-md-4 dashboard-users-success">
                <div class="card text-center bg-danger">
                  <div class="card-body py-1">
                    ...
                    <div class="text-white line-ellipsis">
                      <h3 class="text-white"> Occupied</h3>
                    </div>
                    <h2 class="text-white mb-0">
                      <?php echo number_format($Hostel->countBedSpaceByHostelIdRoomIdByStatus($hostelId, $roomId, 2)); ?>
                    </h2>
                  </div>
                </div>
              </div>
              <div class="col-md-4 dashboard-users-success">
                <div class="card text-center bg-success">
                  <div class="card-body py-1">
                    ...
                    <h2 class="text-white mb-0">
                      <?php echo number_format($Hostel->countBedSpaceByHostelIdRoomIdByStatus($hostelId, $roomId, 1)); ?>
                    </h2>
                  </div>
                </div>
              </div>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <button onclick="window.history.back();" class="btn btn-dark btn-md btn-rounded" type="button"><span
                    ...
                    <table class="table table-striped text-center">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <?php echo $bonk->book_duration ?? '<span class="badge badge-warning badge-pill">Not Booked</span>'; ?>
                          </td>
                          ...
                          <td><?php if ($bonk->is_available == 1) {
                            ...
                            <button type="button" class="badge badge-dark badge-pill m-1 checkOutBtn_"
                          ...
                          <td>
                            ...
                            <button type="button" title="Assign Bed Space to student"
                              class="btn btn-dark btn-md btn-rounded-0 assign_bedspace_btn"
                              data-id="<?php echo $bonk->bedId; ?>" data-amount="<?php echo ($bonk->amount); ?>"
                              data-bed="<?php echo $bonk->bed_space; ?>"><span class="fa fa-check-circle"></span>
                              Assign</button>
                            <?php else : ?>
                            <?php if ($bonk->amount_paid == NULL || $bonk->amount_paid < $bonk->amount) : ?>
                            <button type="button"
                              onclick="window.location.href='updateBedPayments?bed_occupant=<?php echo $Configuration->saltifyString($bonk->occupant); ?>&bedspace=<?php echo $Configuration->saltifyString($bonk->bedId); ?>&hoId=<?php echo $Configuration->saltifyString($hostelId); ?>&action=topuppayment'"
                              title="Update Payment" class="badge badge-warning badge-pill m-1">Pay More</button>
                            <?php endif ?>
                            <button
                              onclick="window.location.href='bedspace_payments?occupant=<?php echo $bonk->occupant; ?>&bed=<?php echo $bonk->bedId; ?>&hoId=<?php echo $hostelId; ?> &action=view-payments'"
                              type="button" title="View Payment History"
                              class="badge badge-info badge-pill">Reciept</button>
                            <?php endif ?>
                          </td>
                        </tr>
                        <?php
  ...
  $(document).ready(function() {
    ...
    checkOutBtn.on("click", function() {
      let studentId = $(this).data("occupant"),
        bedSpaceId = $(this).data("id"),
        action = $(this).data("action");
      if (confirm(
          "The information on the selected bed space will be removed, Are you sure you want to checkout this student?"
        )) {
    ...
    $("#hostelAssignForm").on("submit", function(event) {
      ...
      $(".__loadingBtn__bed_assigned").html(
        '<img src="../assets/loaders/rolling_loader.svg" width="30"> Processing...').attr("disabled", true);
      //send request
