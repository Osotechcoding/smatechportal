...
<div class="row">
             <div class="col-12">
    <h3 class="bd-lead text-primary text-bold"><span class="fa fa-certificate fa-1x"></span> CSV FILE UPLOADER </h3>
  </div>
    </div>
   <!--  -->
  ...
  <div class="row">
    ...
    <div class="col-md-4 col-12">
      <div class="card">
        ...
        <div class="card-body">
          <div class="text-center"> <h4 class="text-uppercase text-center text-muted mt-1">Student Information</h4></div>
          <form class="form form-vertical">
            <div class="form-body">
              <div class="row">
                <div class="col-12">
