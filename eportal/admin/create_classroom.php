  ...
  <?php include ("template/Sidebar.php"); ?>
   ...
   <div class="modal fade" id="synchronizeStaffModalForm" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered">
              <div class="modal-content">
                <div class="modal-header">
                  <h2 class="modal-title" id="exampleModalLongTitle" style="font-size: 30px;font-weight: 700;"><i class="fa fa-edit fa-1x"></i> Please upgrade to Premium version To use this functionality</h2>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i class="bx bx-x"></i>
                  </button>
                </div>
