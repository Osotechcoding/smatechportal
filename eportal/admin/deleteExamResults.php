...
<body class="vertical-layout vertical-menu-modern semi-dark-layout 2-columns  navbar-sticky footer-static  "
                      ...
                      <div class="row">
                        <div class="col-md-3">
                          <div class="form-group">
                            ...
                            <select name="show_result_subject" id="show_result_subject"
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            ...
                            <select name="show_result_class" id="result_class"
                              class="custom-select form-control form-control-lg">
                              <option value="">Choose...</option>
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            ...
                            <select name="show_result_session" id="result_session"
                              class="custom-select form-control form-control-lg">
                              <option value="">Choose...</option>
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            ...
                            <select name="show_result_term" class="custom-select form-control">
                              <option value="">Choose...</option>
                        ...
                        <div class="col-12 d-flex justify-content-end mt-1">
                          <button type="submit" name="show_uploaded_result_btn" class="btn btn-danger btn-lg mr-1"><span
                              class="fa fa-address-card"></span> View Uploaded Exam</button>
                        </div>
                      </div>
                    </div>
                  </form>
                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><button
                              class="btn btn-danger btn-md btn-rounded __loadingBtn__<?php echo $value->reportId; ?> delete_exam_btn"
                              data-id="<?php echo $value->reportId; ?>" data-action="remove_subject_from_result_tbl"
                              data-term="<?php echo $result_term; ?>">Delete</button> </td>
                        </tr>
                        <?php }
                              ?>
                      </tbody>
  ...
  <script src="smappjs/deleteExamResults.js"></script>
