...
<head>
  ...
  <body class="vertical-layout vertical-menu-modern semi-dark-layout 2-columns  navbar-sticky footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns" data-layout="semi-dark-layout">
            ...
            <div class="breadcrumbs-top">
              ...
              <div class="breadcrumb-wrapper d-none d-sm-block">
                <ol class="breadcrumb p-0 mb-0 pl-1">
                  ...
                  <li class="breadcrumb-item active">Student Hostel Payment Reciept
                  </li>
                </ol>
              </div>
            </div>
    ...
    <h3 class="bd-lead text-warning text-bold"><span class="fa fa-address-card fa-1x"></span> <?php echo strtoupper($student_data->full_name);?> PAYMENTS INFO &raquo;</h3>
  </div>
    </div>
    ...
    <div class="col-xl-12 col-md-12 col-12">
      <div class="card invoice-print-area">
        <div class="card-body pb-0 mx-25">
          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-md-12">
              ...
              <span><?php echo $get_data->receiptNo; ?></span>
            </div>
        ...
        <div class="card-body pt-0 mx-25">
          ...
          <a href="print_hostel_payment_receipt?bedss=<?php echo $bedId;?>&hostelreceipt=<?php echo $paymentId;?>&action=printreceipt" target="_blank"><button class="btn btn-dark btn-block">
             <i class="bx bxs-printer"></i>
              <span>Print Now</span>
            </button></a>
            <button onclick="window.history.back();" class="btn btn-danger btn-md btn-rounded mt-1 text-right pull-right" type="button"><span class="fa fa-arrow-left"></span> Go Back</button> 
          </div>
          </div>
        </div>
      </div>
