                ...
                <div class="card-body">
                  ...
                  <div class="text-center">
                    <center><?php if ($student_data->stdPassport == NULL || $student_data->stdPassport == "") : ?>
                      ...
                      <img src="../schoolImages/students/male.png" width="150" height="150" alt="photo"
                        style="border-radius: 10px;border: 3px solid dimgrey;">
                      <?php else : ?>
                      <img src="../schoolImages/students/female.png" width="150" height="150" alt="photo"
                        style="border-radius: 10px;border: 3px solid dimgrey;">
                      <?php endif ?>
                      <?php else : ?>
                      <img src="../schoolImages/students/<?php echo $student_data->stdPassport; ?>" width="150"
                        height="150" alt="photo" style="border-radius: 10px;border: 3px solid dimgrey;">
                      <?php endif ?>
                    </center>
                    <br>
                  ...
                  <button type="button" class="btn btn-success btn-sm btn-round btn-block vsbp_btn"
                    id="<?php echo $Configuration->saltifyString($student_data->stdId); ?>">View Bus Payment History <i
                      class="fa fa-bar-chart fa-2x"></i></button>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-12">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <select name="route_name" id="routeDescName"
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <textarea name="busStops" id="busStopsCovered" readonly
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <input type="text" autocomplete="off" class="form-control form-control-lg" name="busname"
                              id="routeVehicleCapacity" readonly>
                          </div>
                        </div>
                        <div class="col-md-12">
                          <div class="form-group">
                            <label for="routeDriverName">Driver</label>
                            <input type="text" autocomplete="off" class="form-control form-control-lg" name="awako"
                              id="routeDriverName" readonly>
                          </div>
                        </div>
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="text" autocomplete="off" class="form-control form-control-lg" name="price">
                          </div>
                        </div>
                        <div class="col-6">
                          <div class="form-group">
                        ...
                        <div class="col-6">
                          <div class="form-group">
                            ...
                            <input type="password" class="form-control" name="auth_code" placeholder="*************">
                          </div>
                        </div>
                        ...
                        <div class="col-12 d-flex justify-content-end">
                          ...
                          <a href="student_n_bus"><button type="button"
                              class="btn btn-outline-danger btn-sm btn-round">Go Back <i
                                class="fa fa-power-off fa-2x"></i></button></a>
                        </div>
                      </div>
                    </div>
                  </form>
