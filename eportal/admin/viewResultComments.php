...
<head>
  ...
  <title><?php echo $SmappDetails->school_name; ?> :: Student Result Comments </title>
      ...
      <div class="content-body">
                      ...
                      <div class="row">
                        <div class="col-md-5">
                          <div class="form-group">
                            ...
                            <select name="comment_class" id="comment_class" class="form-control custom-select">
                        ...
                        <div class="col-12 d-flex justify-content-end">
                          <button type="submit" name="show_comment_sheet_btn" class="btn btn-dark mr-1">Show
                            Comments</button>
        ...
        <div class="card show-on-print">
          ...
          <div class="card-body">
            ...
            <h4 class="text-center text-danger"><strong>STUDENTS COMMENT REPORT</strong></h4>
            <!-- ############################# -->
            <br />
              ...
              <table class=" table-bordered table table-stripped osotechDatatable table-hover">
                <thead class="text-center">
                  <tr>
                    ...
                    <th width="25%">Teacher's Comment</th>
                ...
                <tbody class="text-center">
                  ...
                  <tr>
                    ...
                    <td><?php echo $value->teacher_comment ?? 'No Comment Yet'; ?> </td>
                    <td><?php echo $value->principal_coment ?? 'No Comment Yet'; ?> </td>
                  </tr>
                  <?php endforeach; ?>
