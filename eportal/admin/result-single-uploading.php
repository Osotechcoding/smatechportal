...
&& $_GET['student-id'] != '' && $_GET['term'] != '' && $_GET['student-class'] != '' && $_GET['cses'] != ''){
  ...
  $cses = $Configuration->Clean($_GET['cses']);
...
<div class="row">
             <div class="col-12">
    <h3 class="bd-lead text-primary text-bold"><span class="fa fa-line-chart fa-2x"></span> Upload <span class="text-muted"><?php echo $term ." ". $cses." Result for ". strtoupper($student_data->full_name);?></span> </h3>
  </div>
    </div>
    <!-- content goes here -->
...
<section>
   <!-- BROADSHEET GOES HERE -->
       <!-- show the broadsheet -->
        ...
        <h4 class="text-info text-center">Current Class: <?php echo strtoupper($student_data->studentClass) ?></h4>
                  <h5 class="text-center text-warning"><?php echo $term; ?> Report Sheet</h5>
        <h3 class="text-center text-info"><strong><?php echo $cses; ?> Academic performance  Sheet</strong></h3>
                        <!-- ############################# -->
            <br />
          ...
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
             <div class="table-responsive">
                    <table class="table table-stripped">
                        ...
                        <tbody>
                       <?php 
                       $registeredSubjects = $Student->studentExamSubjectIsUploaded($student_data->studentClass);
                    ...
                    <td width="40%"> <input type="text" max="40" name="subject[]"  class="form-control form-control-lg" value="<?php echo $registered->subject_name; ?>" readonly></td>
                    <td width="25%"><input type="number" max="40" name="ca[]" class="form-control form-control-lg" placeholder="C.A" required></td>
                  <td width="25%"><input type="number" max="60" name="exam[]" class="form-control form-control-lg" placeholder="60" required></td>
  ...
  <!-- Ends -->
   ...
   <?php include "../template/footer.php"; ?>
    ...
    <script src="smappjs/upload-single.js"></script>
     <!-- BEGIN: Page JS-->
  </body>
  <!-- END: Body-->
</html>