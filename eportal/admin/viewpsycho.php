  ...
  <div class="app-content content">
    ...
    <div class="content-wrapper">
      ...
      <div class="content-body">
        <div class="row">
          <div class="col-12">
            <h3 class="bd-lead text-primary text-bold"><span class="fa fa-line-chart fa-2x"></span> Uploaded Students
              Affective Domain </h3>
          </div>
        </div>
        <!-- content goes here -->
                          ...
                          <div class="row">
                            <div class="col-md-4">
                              <div class="form-group">
                                ...
                                <select name="_class_name" id="_class_name" class="custom-select form-control">
                            ...
                            <div class="col-md-4">
                              <div class="form-group">
                                ...
                                <select name="school_session" id="school_session" class="custom-select form-control">
                                  <option value="" selected>Choose...</option>
                            ...
                            <div class="col-12 d-flex justify-content-end">
                              <button type="submit" name="view_cognitive_btn" class="btn btn-dark mr-1">View Affective
                                Domain</button>
                            </div>
                          </div>
                        </div>
