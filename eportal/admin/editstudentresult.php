...
<body class="vertical-layout vertical-menu-modern semi-dark-layout 2-columns  navbar-sticky footer-static  "
      ...
      <div class="content-body">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <h5 class="text-center text-info"><strong>YOU ARE ABOUT TO UPDATE <b
                  class="text-center text-warning"><?php echo strtoupper($student_data->full_name); ?></b> EXAM SCORE
                SHEET ON <?php echo strtoupper($subject) ?> FOR <?php echo strtoupper($session) ?>
                <?php echo strtoupper($term) ?> </strong></h5>
  ...
  <script src="smappjs/editstudentresult.js"></script>
</body>
<!-- END: Body-->
