...
<body class="vertical-layout vertical-menu-modern semi-dark-layout 2-columns  navbar-sticky footer-static  "
        ...
        <div class="card">
          <div class="card-header">
            <button type="button" class="btn btn-dark btn-md btn-rounded" data-toggle="modal"
              data-target="#addHolidayModal"><span class="fa fa-calendar fa-1x"></span> Add Event</button>
          </div>
          <div class="card-body">
  ...
  <!-- BEGIN: Footer-->
  <!-- BUS MODAL Start -->
  <div class="modal fade" id="addHolidayModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
    aria-hidden="true">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h2 class="modal-title" id="exampleModalLongTitle" style="font-size: 30px;font-weight: 700;"><span
              class="fa fa-calendar fa-1x"></span> Add Upcoming Event</h2>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="event_desc"> TITLE</label>
                    <input type="text" autocomplete="off" class="form-control" name="event_desc"
                      placeholder="A Day Sweing Workshop">
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="event_organizer"> ORGANIZER </label>
                    <input type="text" class="form-control" name="event_organizer" placeholder="Student Union">
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="event_venue" placeholder="School Main Hall">
                  </div>
                </div>
                <div class="col-12 mt-1">
                  <fieldset class="form-label-group mb-0">
                    <textarea data-length=63000 class="form-control char-textarea" id="textarea-counter" rows="3"
                      placeholder="Event Content (Max Character (63000))" name="event_detail"></textarea>
                    <label for="textarea-counter">Event Content (Max Character (1000))</label>
                  </fieldset>
                  <small class="counter-value float-right"><span class="char-count">0</span> / 63000 </small>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="lecture_mp4">Event Image <span class="text-danger">(png,jpg or jpeg format
                        Only)</span></label>
                    <input type="file" class="form-control form-control-lg" id="EventImage" name="EventImage"
                      onchange="previewFile(this);">
                  </div>
                  <div class="col-md-6 " id="uploaded_passport">
                    <img id="previewImg" width="100" src="../assets/loaders/placeholder.png" alt="Placeholder"
                      style="border: 2px solid darkblue;border-radius:10px;">
                    <p>Size: <span id="ImageSize"></span></p>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
  ...
  <div class="modal fade text-left" id="ReadEventDetailModal" tabindex="-1" role="dialog"
  ...
  <script src="smappjs/add_event.js"></script>
</body>
<!-- END: Body-->
