...
<body class="vertical-layout vertical-menu-modern semi-dark-layout 2-columns  navbar-sticky footer-static  "
                  ...
                  <div class="card">
                    <div class="card-header">
                      <button type="button" class="btn btn-dark btn-md badge-pill" data-toggle="modal"
                        data-target="#csv_PsychomotorDomainModal"><span class="fa fa-file fa-1x"></span> Import
                        Affective
                        Score</button>
                    </div>
                    <div class="card-body">
  ...
  <!--  -->
  <!-- BUS MODAL Start -->
  <div class="modal fade" id="csv_PsychomotorDomainModal" tabindex="-1" role="dialog"
    aria-labelledby="exampleModalLongTitle" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header">
          <h3 class="modal-title" id="exampleModalLongTitle" style="font-size: 30px;font-weight: 700;"><i
              class="fa fa-upload fa-1x"></i> Import Student Psychomotor Score</h3>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <i class="bx bx-x"></i>
          </button>
        </div>
        <form id="bulkStudentPsychomotorDomainImportForm" enctype="multipart/form-data">
          <div class="modal-body">
            <div class="text-center">
              <p><a href="../csv/student_psychomotor.xlsx" target="_blank"
              ...
              <p> Enter the Student Psychomotor Details following the
            ...
            <div class="col-md-12 col-12 col-xl-12 col-lg-12 col-sm-12">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="cstudent_class">Psychomotor Class</label>
                    <select name="cstudent_class" id="cstudent_class" class="custom-select form-control">
                      <option value="" selected>Choose...</option>
                      <?php echo $Administration->get_classroom_InDropDown_list(); ?>
                    </select>
                  </div>
                ...
                <input type="hidden" name="csv_psycho_schol_ses" value="<?php echo $activeSess->session_desc_name; ?>">
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="psycho_file">Choose CSV,Excel File </label>
                    <input type="file" name="psycho_file" id="psycho_file" accept=".csv,.xlsx,.xls"
  ...
  <script src="./smappjs/psychomotor.js"></script>
  <!-- BEGIN: Page JS-->
  <script>
  $(document).ready(() => {
    $("#bulkStudentPsychomotorDomainImportForm").on("submit", function(event) {
