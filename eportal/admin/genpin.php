      ...
      <div class="content-body">
        ...
        <div class="row">
          <div class="col-12 mb-1">
            <h3 class="bd-lead text-bold" style="font-weight: bolder;"><i class="fa fa-credit-card-alt"></i> Scratch
              Card Generator</h3>
          </div>
        </div>
        ...
        <div class="col-md-8 offset-1">
          ...
          <div class="card">
            ...
            <h1 class="text-center mt-2" style="font-weight: bolder;"><span class="fa fa-credit-card-alt"></span>
              <?php echo strtoupper(__OSO_APP_NAME__); ?> PIN GENERATOR</h1>
            <div class="card-body">
