      ...
      <table class="table table-bordered">
        ...
        if ($paymentLists) {
          ...
          foreach ($paymentLists as $payment) {
           ...
           ?>
           <tr>
             <td><input type="hidden" name="count_total[]" value="<?php echo $cnt;?>"><?php echo $cnt;?></td>
             <td> <input type="hidden" name="fid[]" value="<?php echo $payment->faId;?>"><?php echo $payment->component_id;?></td>
             <td><input type="text" name="default_price[]" value="<?php echo number_format($payment->amount,2);?>" readonly class="form-control"></td>
             <td><input type="number" name="new_price" placeholder="Set fee" class="form-control" required></td>
