              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <select name="result_subject" id="result_subject" class="custom-select form-control form-control-lg">
                 ...
                 <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <select name="result_class" id="result_class" class="custom-select form-control form-control-lg">
                      <option value="">Choose...</option>
