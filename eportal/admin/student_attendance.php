  ...
  <div class="app-content content">
    ...
    <div class="content-wrapper">
      ...
      <div class="content-body">
        <div class="row">
          <div class="col-12">
            <h3 class="bd-lead text-primary text-bold"><span class="fa fa-line-chart fa-1x"></span> STUDENT ATTENDANCE
            </h3>
          </div>
        </div>
        <!-- content goes here -->
                      ...
                      <form class="form form-vertical" action="" method="POST">
                        <div class="form-body">
                          <div class="row">
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <select name="class_name" id="class_name" class="custom-select form-control">
                          ...
                          <button type="submit" name="show_broad_sheet_btn"
                            class="btn btn-dark btn-md badge-pill float-right">Mark Attendance</button>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <h2 class="card-title text-danger text-center">Enter Roll Call For (<b
                class="text-info"><?php echo strtoupper($show_class); ?></b>)</h2>
            <form id="submit_attendant_form">
              <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 mb-3">
                  <div class="form-group">
                    ...
                    <input type="text" name="term" class="form-control" value="<?php echo $activeSess->term_desc ?>"
                      readonly>
                  </div>
                </div>
              ...
              <div class="table-responsive">
                <table class="table-bordered table table-stripped mb-5">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><?php echo $cnt; ?> </td>
                      <td>
                        <input type="hidden" name="student_classroom[]"
                          value="<?php echo strtoupper($valuemi->studentClass); ?>">
                        <input type="text" name="student_name[]" readonly
                          value="<?php echo strtoupper($valuemi->full_name); ?>" class="form-control">
                      </td>
                      <td><input type="text" name="reg_number[]" readonly
                          value="<?php echo strtoupper($valuemi->stdRegNo); ?>" class="form-control"></td>
                      <td width="11%">
                ...
                <button type="submit" class="btn btn-success btn-lg float-right __loadingBtn__"> SUBMIT
                  ATTENDANCE</button>
                <div class="clearfix"></div>
              </div>
            </form>
