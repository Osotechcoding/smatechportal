...
<head>
  ...
  <title><?php echo $SmappDetails->school_name ?> :: Update <?php echo ucwords($staff_data->full_name); ?> Information
  </title>
...
<body class="vertical-layout vertical-menu-modern semi-dark-layout 2-columns  navbar-sticky footer-static  "
        ...
        <div class="row">
          <div class="col-12">
            <h3 class="bd-lead text-primary text-bold">
              ...
              <img src="../author.jpg" width="100" alt="photo"
                style="border-radius: 10px;border: 3px solid deepskyblue;">
              <?php else : ?>
              <img src="../schoolImages/staff/<?php echo $staff_data->staffPassport; ?>" width="100" alt="photo"
                style="border-radius: 10px;border: 3px solid deepskyblue;">
              <?php endif ?> <b class="text-muted"><?php echo $tTitle . "" . ucwords($staff_data->full_name); ?>'s</b>
              Profile
            </h3>
          </div>
        </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-8 form-group">
                          <input type="text" class="form-control" name="surname"
                            value="<?php echo $staff_data->lastName; ?>" placeholder="SurName">
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-8 form-group">
                          <input type="text" class="form-control" name="fname" placeholder="First Name"
                            value="<?php echo $staff_data->firstName; ?>">
                        </div>
                        <div class="col-md-4">
                          <label>Phone Number</label>
                        </div>
                        <div class="col-md-8 form-group">
                          <input type="text" class="form-control" name="phone" placeholder="First Name"
                            value="<?php echo $staff_data->staffPhone; ?>">
                        </div>
                        ...
                        <div class="col-md-8 form-group">
                          <input type="email" id="email-id" class="form-control" name="email-id" placeholder="Email"
                            readonly value="<?php echo $staff_data->staffEmail; ?>">
                        </div>
                        <div class="col-md-4">
                          <label> Address:</label>
                        </div>
                        <div class="col-md-8 form-group">
                          <textarea name="address" class="form-control"
                            placeholder="Write address"><?php echo $staff_data->staffAddress; ?></textarea>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-8 form-group">
                          <input type="text" class="form-control" name="admission_no" placeholder="Admission No"
                            value="<?php echo $staff_data->staffRegNo; ?>" readonly>
                        </div>
                        <div class="col-md-4">
                          <label>Staff Role:</label>
                        </div>
                        <div class="col-md-8 form-group">
                          <input type="text" class="form-control" name="admission_no" placeholder="Staff Role"
                            value="<?php echo $staff_data->staffRole; ?>" readonly>
                        </div>
                        <div class="col-md-4">
                          <label>Staff Type:</label>
                        </div>
                        <div class="col-md-8 form-group">
                          <input type="text" class="form-control" name="staffType" placeholder="Staff Role"
                            value="<?php echo $staff_data->staffType; ?>" readonly>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-8 form-group">
                          <select name="presentClass" class="form-control custom-select">
                            <option value="<?php echo $staff_data->staffGrade; ?>" selected>
                              <?php echo $staff_data->staffGrade ?></option>
                        ...
                        <div class="col-md-8 form-group">
                          <select name="gender" class="form-control custom-select">
                            <option value="<?php echo $staff_data->staffGender ?>" selected>
                              <?php echo $staff_data->staffGender; ?></option>
                        ...
                        <div class="col-md-8 form-group">
                          <select name="education" class="form-control custom-select">
                            <option value="<?php echo $staff_data->staffEducation ?>" selected>
                              <?php echo $staff_data->staffEducation; ?></option>
                        ...
                        <div class="col-md-8 form-group">
                          <input type="text" class="form-control" name="pusername" placeholder="Portal Username"
                        ...
                        <div class="col-md-8 form-group">
                          <input type="password" autocomplete="off" class="form-control" name="approved"
                            placeholder="Pls authenticate this update">
                        </div>
  ...
  <script src="smappjs/editstaffinfo.js"></script>
  <!-- BEGIN: Page JS-->
</body>
<!-- END: Body-->
