...
<body class="vertical-layout vertical-menu-modern semi-dark-layout 2-columns  navbar-sticky footer-static  "
              ...
              <div class="card">
                <div class="card-header">
                  <button type="button" class="btn btn-dark btn-md btn-round" data-toggle="modal"
                    data-target="#routeModal"><span class="fa fa-plus fa-1x"></span> Add</button>
                </div>
                    ...
                    <table class="table table-striped table-bordered osotechDatatable">
                      ...
                      <tbody class="text-center">
                        ...
                        <tr>
                          ...
                          <td><?php echo ucwords($route->bus_stops); ?>
                            <!-- <?php //foreach ($busstops_arr as $value): 
                                      ?>
                    <span class="badge badge-pill badge-dark badge-md mb-1"><?php //echo $value;
                                                                            ?></span>
                  <?php //endforeach 
                  ?> -->
                          </td>
                          <td>&#8358;<?php echo number_format($route->route_price, 2); ?></td>
                          <td><button type="button" title="Edit"
                              class="badge badge-pill badge-dark badge-md m-1 edit_route_btn"><span
                                class="fa fa-edit"></span> Edit</button> <button type="button"
                              class="badge badge-pill badge-danger badge-md delete_route_btn"
                              data-id="<?php echo $route->id; ?>" data-action="delete"><i class="fa fa-trash"></i>
                              Delete</button></td>
                        </tr>
                        <?php
                          }
  ...
  <div class="modal fade" id="routeModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
    aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h2 class="modal-title" id="exampleModalLongTitle" style="font-size: 30px;font-weight: 700;"><i
              class="fa fa-bus fa-1x"></i> Add Routes</h2>
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" autocomplete="off" class="form-control form-control-lg" name="route_name"
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="busstops">Bus Stops <span class="text-danger">(B/Stops should be separarted by
                        commas</span>) </label>
                    <textarea class="form-control form-control-lg" name="busstops"
                      placeholder="e.g gasline,Poultry,NNPC, Four Junction etc"></textarea>
                  </div>
                </div>
