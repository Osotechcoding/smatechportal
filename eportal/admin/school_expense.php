...
<body class="vertical-layout vertical-menu-modern semi-dark-layout 2-columns  navbar-sticky footer-static  "
  ...
  <div class="app-content content">
    ...
    <div class="content-wrapper">
      ...
      <div class="content-body">
        <div class="row">
          <div class="col-12">
            <h3 class="bd-lead text-primary text-bold"><span class="fa fa-bar-chart fa-2x"></span> SCHOOL EXPENSES
              MANAGEMENT</h3>
          </div>
        </div>
                  ...
                  <div class="card text-center bg-warning">
                    <div class="card-body py-1">
                      ...
                      <h2 class="text-white mb-0">
                        &#8358;<?php echo number_format($Administration->get_all_today_expenses(), 2) ?></h2>
                    </div>
                  </div>
                </div>
                <div class="col-md-4 dashboard-users-success">
                  <div class="card text-center bg-danger">
                    <div class="card-body py-1">
                      ...
                      <div class="text-white line-ellipsis">
                        <h3 class="text-white">Current Term </h3>
                      </div>
                      <h2 class="text-white mb-0">
                        &#8358;<?php echo number_format($Administration->get_all_expenses_this_term($activeSess->term_desc, $activeSess->session_desc_name), 2) ?>
                      </h2>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-4 dashboard-users-success">
                  <div class="card text-center bg-dark">
                    <div class="card-body py-1">
                      ...
                      <div class="text-white line-ellipsis">
                        <h3 class="text-white">Current Session </h3>
                      </div>
                      <h2 class="text-white mb-0">
                        &#8358;<?php echo number_format($Administration->get_all_expenses_this_session($activeSess->session_desc_name), 2) ?>
                      </h2>
              ...
              <div class="card">
                <div class="card-header">
                  <button type="button" class="btn btn-dark btn-md btn-round" data-toggle="modal"
                    data-target="#busModal"><span class="fa fa-line-chart fa-1x"></span> Add Expense</button>
                </div>
                    ...
                    <table class="table table-striped table-bordered osotechDatatable">
                      ...
                      <tbody class="text-center">
                        ...
                        <tr>
                          ...
                          <td><span
                              class="badge badge-pill badge-success badge-md"><?php echo date("D j F Y", strtotime($expenses->created_on)); ?></span>
                          </td>
                          <td><button data-action="remove_school_expense_details"
                              data-id="<?php echo $expenses->expense_id; ?>" type="button"
                              class="badge badge-pill badge-danger badge-md delete_btn loadingBtn___<?php echo $expenses->expense_id; ?>"><i
                                class="fa fa-trash"></i>
                              Delete</button></td>
                        </tr>
                        <?php
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h2 class="modal-title" id="exampleModalLongTitle" style="font-size: 30px;font-weight: 700;"><i
              class="fa fa-line-chart fa-1x"></i> Expense Form</h2>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" name="expense_desc" id="expense_desc" class="form-control form-control-lg"
                      placeholder="e.g Payment of Staff salary...">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="price">COST OF EXPENSES</label>
                    <input type="text" autocomplete="off" class="form-control form-control-lg" name="expense_cost"
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" autocomplete="off" class="form-control form-control-lg" id="paid_to"
                      name="reciever" placeholder="Enter the receiver name here">
                  </div>
                </div>
  ...
  <script src="smappjs/school_expense.js"></script>
</body>
<!-- END: Body-->
