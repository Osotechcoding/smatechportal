...
<body class="vertical-layout vertical-menu-modern semi-dark-layout 2-columns  navbar-sticky footer-static  "
                ...
                <div class="card text-center bg-info">
                  <div class="card-body py-1">
                    ...
                    <div class="text-white line-ellipsis">
                      <h3 class="text-white">Staff Alawi</h3>
                    </div>
                    <h2 class="text-white mb-0">&#8358; <?php echo number_format($Payroll->getAllSumOfAlawis(), 2); ?>
                    </h2>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4 dashboard-users-success">
                <div class="card text-center bg-danger">
                  <div class="card-body py-1">
                    ...
                    <div class="text-white line-ellipsis">
                      <h3 class="text-white"> TAX (TDS)</h3>
                    </div>
                    <h2 class="text-white mb-0">&#8358;<?php echo number_format($Payroll->get_sum_of_total_tds(), 2); ?>
                    </h2>
                  </div>
                </div>
              </div>
              <div class="col-md-4 dashboard-users-success">
                <div class="card text-center bg-dark">
                  <div class="card-body py-1">
                    ...
                    <div class="text-white line-ellipsis">
                      <h3 class="text-white">Monthly Salaries</h3>
                    </div>
                    <h2 class="text-white mb-0">
                      &#8358;<?php echo number_format($Payroll->get_sum_of_total_salary_payout_monthly(), 2); ?></h2>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card">
                <div class="card-header">
                  <button type="button" class="btn btn-dark btn-md btn-rounded" data-toggle="modal"
                    data-target="#uploadStaffSalaryModal"><span class="fa fa-money fa-1x"></span> Add Payroll</button>
                </div>
                            ...
                            <div class="btn-group dropdown mr-1 mb-1">
                              ...
                              <div class="dropdown-menu" aria-labelledby="dropdownMenuOffset">
                                ...
                                <a class="dropdown-item text-warning pay_form_btn"
                                  ...
                                  data-payroll="<?php echo $payrolls->payrollId; ?>" href="javascript:void(0);"> Make
                                  Payment</a>
                                <a class="dropdown-item text-info"
                                  href="salary_history?staffId=<?php echo $payrolls->staff_id; ?>&action=viewsalary">
                                  Salary History</a>
                              </div>
                            </div>
                          </td>
    ...
    <div class="modal-dialog modal-md" role="document">
      <div class="modal-content">
        <div class="modal-header text-center">
          <h1 class="modal-title text-info text-center" id="exampleModalLabel"><span
              class="fa fa-credit-card icon-lg"></span> STAFF BANK DETAILS</h1>
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h2 class="modal-title" id="exampleModalLongTitle" style="font-size: 30px;font-weight: 700;"><i
              class="fa fa-line-chart fa-1x"></i> Salary structure</h2>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <i class="bx bx-x"></i>
          </button>
        </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <select name="staffId" id="staff_name" class="select2 form-control form-control-lg">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="number" autocomplete="off" class="form-control form-control-lg" name="basic_salary"
                      placeholder="required" min="5000">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="rent_alawi">RENT ALLOWANCE</label>
                    <input type="number" autocomplete="off" name="rent" class="form-control form-control-lg"
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="number" autocomplete="off" name="transport" class="form-control form-control-lg"
                      placeholder="Optional">
                  </div>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control form-control-lg" name="tds_tax" required
  ...
  <div class="modal fade" id="salary-payment-modal" tabindex="-1" role="dialog">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" id="our_school_term" type="text" name="our_school_term"
                      value="<?php echo $activeSess->term_desc; ?>" readonly>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="our_school_session">Session</label>
                    <input class="form-control" id="our_school_session" type="text" name="our_school_session"
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" id="amount_paid" type="text" placeholder="Enter net salary e.g 20000"
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" id="bank_ref_no" type="text" name="bank_ref_no"
                      placeholder="e.g 1234560-098754">
                  </div>
                </div>
              </div>
              <div class="col-md-6">
  ...
  $(document).ready(function() {
    ...
    STAFF_SALARY_PAYMENT_FORM.on("submit", function(event) {
      event.preventDefault();
      $(".__loadingBtnpaid__").html('<img src="../assets/loaders/rolling_loader.svg" width="30"> Processing...')
        .attr("disabled", true);
      //send request
