          ...
          <div class="alert alert-warning alert-dismissible mb-2" role="alert">
            ...
            <div class="d-flex align-items-center">
              ...
              <h3 class="text-center text-white"> <span>
                  <strong class="text-center"> Welcome to <?php echo __OSO_APP_NAME__ ?>
                    <?php echo __OSO_APP_VERSION__; ?> BACKUP & RESTORE MODULE!</strong>
                </span></h3>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6 col-sm-12 col-xl-6">
              <div class="card">
                <div class="card-body">
                  <a href="mybackup?process=backup" style="text-decoration: none; color: #fff;font-size: 35px;"
                    class="btn btn-success btn-block"><span class="fa fa-database icon-lg text-white"></span> BACKUP
                    NOW</a>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-6 col-sm-12 col-xl-6">
              <div class="card">
                <div class="card-body">
                  <a href="mybackup?process=restore" style="text-decoration: none; color: #fff;font-size: 35px;"
                    class="btn btn-warning btn-block"><span class="fa fa-server icon-lg"></span> RESTORE BACKUP</a>
                </div>
