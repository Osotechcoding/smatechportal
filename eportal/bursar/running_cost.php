            ...
            <div class="col-md-4 dashboard-users-success">
              <div class="card text-center bg-success">
                <div class="card-body py-1">
                  ...
                  <div class="text-white line-ellipsis"><h3 class="text-white"><?php echo date("D jS F, Y");?> </h3></div>
             ...
             <div class="col-md-4 dashboard-users-success">
              <div class="card text-center bg-info">
                <div class="card-body py-1">
                  ...
                  <h2 class="text-white mb-0">&#8358;<?php echo number_format($Administration->get_all_money_paid_by_term($activeSess->session_desc_name,$activeSess->term_desc),2) ?></h2>
                   <div class="text-white line-ellipsis"><h3 class="text-white"><?php echo $activeSess->term_desc?> </h3></div>
              ...
              <div class="card text-center bg-dark">
                <div class="card-body py-1">
                  ...
                  <div class="text-white line-ellipsis"><h3 class="text-white">Session <?php echo $activeSess->session_desc_name; ?> </h3></div>
                </div>
              </div>
            </div>
