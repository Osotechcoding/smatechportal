...
<div class="form-group">
    <select class="custom-select form-control form-control-lg" name="">
      <option value="">Proposed Class Level</option>
...
<div class="form-group">
<button class="btn btn-dark btn-block __loadingBtn__" type="submit">Submit &amp; Continue</button>
</div>
</form>
