  ...
  <div class="accordion-item">
    ...
    <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
      <div class="accordion-body text-left">
        ...
        <p class="text-center mb-2 text-warning"><strong class="text-danger">STEP ONE :: </strong> Carefully scratch off the covered area of your scratch card to unveil your secret PIN Number</p>
  <p class="text-center mb-2 text-warning"><strong class="text-danger">STEP TWO :: </strong> Enter Your Admission Number in the space provided</p>
      <p class="text-center mb-2 text-warning"><strong class="text-danger">STEP THREE :: </strong> Choose Examination Result Class from the list</p>
      <p class="text-center mb-2 text-warning"><strong class="text-danger">STEP FOUR :: </strong> Select Result Session from the list</p>
      <p class="text-center mb-2 text-warning">  <strong class="text-danger">STEP FIVE :: </strong> Choose your Result Term (1st,2nd or 3rd)</p>
      <p class="text-center mb-2 text-warning"><strong class="text-danger">STEP SIX :: </strong>Enter the PIN Number in your scratch card correctly</p>
      <p class="text-center mb-2 text-warning">  <strong class="text-danger">STEP SEVEN :: </strong> Enter your scratch card SERIAL Number.</p>
      <p class="text-center mb-2 text-warning">  <strong class="text-danger">STEP EIGHT :: </strong> Finaly, Click check result Button and wait for your result to display.</p>
      </div>
        <p class="text-success m-3"> Scratch Cards are available at the school Premises or contact the Admin on <a href="tel:<?php echo ($Osotech->getConfigData()->school_phone);?>" title="Call Admin on <?php echo ($Osotech->getConfigData()->school_phone);?>">Click Here</a></p>
    </div>
  </div>
</div>
