  ...
  <div class="container">
    <div class="footer-top border-bottom pt-5">
      <div class="row">
        <div class="col-lg-3 col-md-6 text-center" data-aos="fade-in" data-aos-duration="1050">
          ...
          <a href="./" class="text-center"><span class="color-orange navbar-brand fw-bold"
              style="font-size: 23px;"><?php echo ($Osotech->getConfigData()->school_short_name); ?></span></a>
          <p><?php echo ($Osotech->getConfigData()->school_name); ?></p>
          <ul class="social-icon">
            <li><a href="<?php echo $Osotech->getAppSocialLinks()->facebook; ?>"><i class="fa fa-facebook-f"></i></a>
            </li>
            <li><a href="<?php echo $Osotech->getAppSocialLinks()->goggle; ?>"><i class="fa fa-google-plus"></i></a>
            </li>
            <li><a href="<?php echo $Osotech->getAppSocialLinks()->twitter; ?>"><i class="fa fa-twitter"></i></a></li>
            <li><a href="<?php echo $Osotech->getAppSocialLinks()->instagram; ?>"><i class="fa fa-instagram"></i></a>
            </li>
        ...
        <div class="col-lg-2 col-md-6" data-aos="fade-in" data-aos-duration="550">
          ...
          <ul>
            ...
            <li><a href="<?php echo ADMISSION_ROOT; ?>" target="_blank"><i
                  class="fa fa-angle-double-right mr-2"></i>Online Registration</a></li>
            <li><a href="<?php echo RESULT_ROOT; ?>" target="_blank"><i class="fa fa-angle-double-right mr-2"></i>Online
                Result</a></li>
            <li><a href="./career" title="Work with Us @ <?php echo ($Osotech->getConfigData()->school_name) ?>"><i
                  class="fa fa-angle-double-right mr-2"></i>Career</a></li>
            <li><a href="<?php echo EPORTAL_ROOT; ?>" target="_blank"><i
                  class="fa fa-angle-double-right mr-2"></i>e-Portal</a></li>
        ...
        <div class="col-lg-3 col-md-6 mb-md-5 mb-4" data-aos="fade-in" data-aos-duration="1050">
          ...
          <div class="row">
            ...
            <div class="col-md-4 col-sm-2 col-2 mb-2 pr-0">
              <img src="<?php echo EPORTAL_ROOT; ?>news-images/<?php echo $value->blog_image; ?>" class="img-fluid"
                alt="News-Image">
            </div>
            <?php
                            }
        ...
        <div class="col-lg-4 col-md-6 pl-lg-5  mb-md-5" data-aos="fade-in" data-aos-duration="1050">
          ...
          <ul class="address-icon">
            <li class="mb-3"><i
                class="fa fa-map-marker mr-3 color-orange"></i><?php echo ($Osotech->getConfigData()->school_address); ?>,
              <?php echo ($Osotech->getConfigData()->school_city); ?>,
              <?php echo ($Osotech->getConfigData()->school_state); ?>,
              <?php echo ($Osotech->getConfigData()->country); ?>.</li>
            <li class="mb-3"><i
                class="fa fa-phone mr-3 color-orange"></i><?php echo ($Osotech->getConfigData()->school_phone); ?>,
              <?php echo ($Osotech->getConfigData()->school_fax); ?></li>
            <li class="mb-3"><i
                class="fa fa-envelope color-orange mr-3"></i><?php echo ($Osotech->getConfigData()->school_email); ?>
            </li>
    ...
    <div class="bottom-footer py-3 d-flex justify-content-between">
      ...
      <ul class="list-inline mb-0">
        ...
        <li class="list-inline-item"><a href="javascript:"><span class="color-orange">Developer:</span>
            <?php echo __OSO_DEV_COMPANY__; ?></a></li>
      </ul>
    </div>
  </div>
</footer>