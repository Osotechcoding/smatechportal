<header class="main-header" id="header">
  <div class="container">
    <nav class="navbar navbar-expand-lg navbar-dark">
      ...
      </a><span class="navbar-brand text-black fw-bold"
        style="color:black"><?php echo ($Osotech->getConfigData()->school_short_name); ?></span>
      ...
      <div class="collapse navbar-collapse justify-content-end" id="collapsibleNavbar">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link" onclick="return window.location.href='<?php echo APP_ROOT; ?>';"
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
              <a class="dropdown-item" onclick="return window.location.href='<?php echo RESULT_ROOT; ?>';"
                href="javascript:void(0);">Online Result</a>
              <a class="dropdown-item" onclick="return window.location.href='<?php echo APP_ROOT; ?>prefects';"
                href="javascript:void(0);">Prefects</a>
              <a class="dropdown-item" onclick="return window.location.href='<?php echo APP_ROOT; ?>alumni';"
                href="javascript:void(0);">Alumni</a>
              <a class="dropdown-item" onclick="return window.location.href='<?php echo ADMISSION_ROOT; ?>';"
                href="javascript:void(0);">Online Registration</a>
            </div>
          </li>
          <li class="nav-item">
            <a class="nav-link" onclick="return window.location.href='<?php echo APP_ROOT; ?>facilities';"
              href="javascript:void(0);">Facilities</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" onclick="return window.location.href='<?php echo APP_ROOT; ?>gallery';"
              href="javascript:void(0);">Gallery</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" onclick="return window.location.href='<?php echo APP_ROOT; ?>blog';"
              href="javascript:void(0);">Blog</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" onclick="return window.location.href='<?php echo APP_ROOT; ?>career';"
              href="javascript:void(0);">Career</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" onclick="return window.location.href='<?php echo APP_ROOT; ?>contact';"
